...
})({"4T3hU":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "a49a8d1fd48996ba";
"use strict";
...
},{}],"7r0UO":[function(require,module,exports,__globalThis) {
// EDIT SECTION
// Import FullCalendar
...
document.addEventListener("DOMContentLoaded", function() {
    const initCalendar = (calendarEl, hiddenInputEl)=>{
        ...
        const calendar = new (0, _core.Calendar)(calendarEl, {
            plugins: [
    ...
    editModals.forEach((modal)=>{
        modal.addEventListener('shown.bs.modal', function() {
            ...
            if (calendarEl && hiddenInputEl && !calendarEl.classList.contains('initialized')) {
                ...
                calendarEl.classList.add('initialized'); // Prevent reinitialization
            }
        });
    });
    ...
    forms.forEach((form)=>{
        form.addEventListener('submit', function(event) {
            ...
            if (availableDatesInput) formData.append('available_dates', availableDatesInput.value);
...
},{"@fullcalendar/core":"dQNZA","@fullcalendar/daygrid":"6nYtW","@fullcalendar/interaction":"84iWu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dQNZA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "JsonRequestError", ()=>(0, _internalCommonJs.ag));
...
class CalendarDataManager {
    constructor(props){
        ...
        let currentDate = (0, _internalCommonJs.G)(optionsData.calendarOptions, optionsData.dateEnv);
        let dateProfile = currentViewData.dateProfileGenerator.build(currentDate);
        if (!(0, _internalCommonJs.H)(dateProfile.activeRange, currentDate)) currentDate = dateProfile.currentRange.start;
        let calendarContext = {
        ...
        let initialState = {
            ...
            eventSources,
            eventUiBases: {},
            eventStore: (0, _internalCommonJs.I)(),
            renderableEventStore: (0, _internalCommonJs.I)(),
            dateSelection: null,
            eventSelection: '',
            eventDrag: null,
            eventResize: null,
    ...
    _handleAction(action) {
        ...
        currentDate = (0, _internalCommonJs.J)(currentDate, action);
        dateProfile = reduceDateProfile(dateProfile, action, currentDate, currentViewData.dateProfileGenerator);
        if (action.type === 'PREV' || // TODO: move this logic into DateProfileGenerator
        action.type === 'NEXT' || // "
        !(0, _internalCommonJs.H)(dateProfile.currentRange, currentDate)) currentDate = dateProfile.currentRange.start;
        let eventSources = reduceEventSources(state.eventSources, action, dateProfile, calendarContext);
        let eventStore = (0, _internalCommonJs.K)(state.eventStore, action, eventSources, dateProfile, calendarContext);
    ...
    updateData() {
        ...
        if (oldCalendarOptions && oldCalendarOptions !== newCalendarOptions) {
            if (oldCalendarOptions.timeZone !== newCalendarOptions.timeZone) {
                ...
                state.eventStore = data.eventStore = (0, _internalCommonJs.L)(data.eventStore, oldData.dateEnv, data.dateEnv);
                state.renderableEventStore = data.renderableEventStore = (0, _internalCommonJs.L)(data.renderableEventStore, oldData.dateEnv, data.dateEnv);
            }
    ...
    processRawCalendarOptions(optionOverrides, dynamicOptionOverrides) {
        let { locales, locale } = (0, _internalCommonJs.M)([
        ...
        let refiners = this.currentCalendarOptionsRefiners = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (0, _internalCommonJs.N)), (0, _internalCommonJs.O)), (0, _internalCommonJs.P)), pluginHooks.listenerRefiners), pluginHooks.optionRefiners);
        let extra = {};
        let raw = (0, _internalCommonJs.M)([
            (0, _internalCommonJs.e),
            localeDefaults,
            optionOverrides,
            dynamicOptionOverrides
        ...
        for(let optionName in raw){
            if (this.optionsForRefining.indexOf(optionName) === -1 && (raw[optionName] === currentRaw[optionName] || (0, _internalCommonJs.Q)[optionName] && optionName in currentRaw && (0, _internalCommonJs.Q)[optionName](currentRaw[optionName], raw[optionName]))) refined[optionName] = currentRefined[optionName];
    ...
    processRawViewOptions(viewSpec, pluginHooks, localeDefaults, optionOverrides, dynamicOptionOverrides) {
        ...
        let refiners = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (0, _internalCommonJs.N)), (0, _internalCommonJs.O)), (0, _internalCommonJs.P)), (0, _internalCommonJs.R)), pluginHooks.listenerRefiners), pluginHooks.optionRefiners);
        let refined = {};
        let currentRaw = this.currentViewOptionsInput;
        let currentRefined = this.currentViewOptionsRefined;
        let anyChanges = false;
        let extra = {};
        for(let optionName in raw)if (raw[optionName] === currentRaw[optionName] || (0, _internalCommonJs.Q)[optionName] && (0, _internalCommonJs.Q)[optionName](raw[optionName], currentRaw[optionName])) refined[optionName] = currentRefined[optionName];
        else {
            if (raw[optionName] === this.currentCalendarOptionsInput[optionName] || (0, _internalCommonJs.Q)[optionName] && (0, _internalCommonJs.Q)[optionName](raw[optionName], this.currentCalendarOptionsInput[optionName])) {
...
function buildDateEnv$1(timeZone, explicitLocale, weekNumberCalculation, firstDay, weekText, pluginHooks, availableLocaleData, defaultSeparator) {
    ...
    return new (0, _internalCommonJs.S)({
...
function buildDateProfileGenerator(props) {
    let DateProfileGeneratorClass = props.dateProfileGeneratorClass || (0, _internalCommonJs.U);
...
function buildViewUiProps(calendarContext) {
    ...
    return {
        eventUiSingleBase: (0, _internalCommonJs.W)({
        ...
        selectionConfig: (0, _internalCommonJs.W)({
...
function parseContextBusinessHours(calendarContext) {
    return (0, _internalCommonJs.X)(calendarContext.options.businessHours, calendarContext);
}
...
class ViewHarness extends (0, _internalCommonJs.B) {
    constructor(){
        ...
        this.handleEl = (el)=>{
            this.el = el;
            (0, _internalCommonJs.Y)(this.props.elRef, el);
...
*/ class EventClicking extends (0, _internalCommonJs.Z) {
    constructor(settings){
        super(settings);
        this.handleSegClick = (ev, segEl)=>{
            let { component } = this;
            let { context } = component;
            let seg = (0, _internalCommonJs._)(segEl);
            if (seg && // might be the <div> surrounding the more link
            component.isValidSegDownEl(ev.target)) {
                // our way to simulate a link click for elements that can't be <a> tags
                // grab before trigger fired in case trigger trashes DOM thru rerendering
                let hasUrlContainer = (0, _internalCommonJs.$)(ev.target, '.fc-event-forced-url');
                let url = hasUrlContainer ? hasUrlContainer.querySelector('a[href]').href : '';
                context.emitter.trigger('eventClick', {
                    el: segEl,
                    event: new (0, _internalCommonJs.a0)(component.context, seg.eventRange.def, seg.eventRange.instance),
                    jsEvent: ev,
                    view: context.viewApi
                });
        ...
        this.destroy = (0, _internalCommonJs.a1)(settings.el, 'click', '.fc-event', this.handleSegClick);
    }
}
/*
Triggers events and adds/removes core classNames when the user's pointer
enters/leaves event-elements of a component.
*/ class EventHovering extends (0, _internalCommonJs.Z) {
    constructor(settings){
        super(settings);
        ...
        this.handleSegEnter = (ev, segEl)=>{
            if ((0, _internalCommonJs._)(segEl)) {
        ...
        this.removeHoverListeners = (0, _internalCommonJs.a2)(settings.el, '.fc-event', this.handleSegEnter, this.handleSegLeave);
    }
    destroy() {
    ...
    triggerEvent(publicEvName, ev, segEl) {
        ...
        if (!ev || component.isValidSegDownEl(ev.target)) context.emitter.trigger(publicEvName, {
            el: segEl,
            event: new (0, _internalCommonJs.a0)(context, seg.eventRange.def, seg.eventRange.instance),
            jsEvent: ev,
            view: context.viewApi
        });
    }
}
class CalendarContent extends (0, _internalCommonJs.a3) {
    constructor(){
        super(...arguments);
        this.buildViewContext = (0, _internalCommonJs.z)((0, _internalCommonJs.a4));
        ...
        this.state = {
            viewLabelId: (0, _internalCommonJs.a5)()
        };
        // Component Registration
        // -----------------------------------------------------------------------------------------------------------------
        this.registerInteractiveComponent = (component, settingsInput)=>{
            let settings = (0, _internalCommonJs.a6)(component, settingsInput);
            ...
            (0, _internalCommonJs.a7)[component.uid] = settings;
        };
        this.unregisterInteractiveComponent = (component)=>{
            ...
            delete (0, _internalCommonJs.a7)[component.uid];
        };
        // Resizing
        // -----------------------------------------------------------------------------------------------------------------
    ...
    */ render() {
        ...
        let toolbarProps = this.buildToolbarProps(props.viewSpec, props.dateProfile, props.dateProfileGenerator, props.currentDate, (0, _internalCommonJs.a8)(props.options.now, props.dateEnv), props.viewTitle);
        let viewVGrow = false;
        let viewHeight = '';
        let viewAspectRatio;
        ...
        return (0, _preact.createElement)((0, _internalCommonJs.V).Provider, {
            value: viewContext
        }, toolbarConfig.header && (0, _preact.createElement)(Toolbar, Object.assign({
            ref: this.headerRef,
...
function buildToolbarProps(viewSpec, dateProfile, dateProfileGenerator, currentDate, now, title) {
    ...
    return {
        ...
        isTodayEnabled: todayInfo.isValid && !(0, _internalCommonJs.H)(dateProfile.currentRange, now),
...
class Calendar extends (0, _internalCommonJs.a9) {
    constructor(el, optionOverrides = {}){
        ...
        this.handleRenderRequest = ()=>{
            if (this.isRendering) {
                ...
                (0, _internalCommonJs.aa)(()=>{
                    (0, _preact.render)((0, _preact.createElement)((0, _internalCommonJs.ab), {
                        ...
                        return (0, _preact.createElement)((0, _internalCommonJs.ac).Provider, {
    ...
    setHeight(height) {
        (0, _internalCommonJs.ae)(this.el, 'height', height);
    }
}
...
function buildDateEnv(settings) {
    ...
    return new (0, _internalCommonJs.S)(Object.assign(Object.assign({
...
*/ function sliceEvents(props, allDay) {
    return (0, _internalCommonJs.af)(props.eventStore, props.eventUiBases, props.dateProfile.activeRange, allDay ? props.nextDayThreshold : null).fg;
}
const version = '6.1.15';

},{"./internal-common.js":"BjSPd","preact":"26zcy","preact/compat":"aF0cT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"BjSPd":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "$", ()=>elementClosest);
...
parcelHelpers.export(exports, "G", ()=>getInitialDate);
parcelHelpers.export(exports, "H", ()=>rangeContainsMarker);
parcelHelpers.export(exports, "I", ()=>createEmptyEventStore);
parcelHelpers.export(exports, "J", ()=>reduceCurrentDate);
parcelHelpers.export(exports, "K", ()=>reduceEventStore);
parcelHelpers.export(exports, "L", ()=>rezoneEventStoreDates);
parcelHelpers.export(exports, "M", ()=>mergeRawOptions);
parcelHelpers.export(exports, "N", ()=>BASE_OPTION_REFINERS);
parcelHelpers.export(exports, "O", ()=>CALENDAR_LISTENER_REFINERS);
parcelHelpers.export(exports, "P", ()=>CALENDAR_OPTION_REFINERS);
parcelHelpers.export(exports, "Q", ()=>COMPLEX_OPTION_COMPARATORS);
parcelHelpers.export(exports, "R", ()=>VIEW_OPTION_REFINERS);
parcelHelpers.export(exports, "S", ()=>DateEnv);
parcelHelpers.export(exports, "T", ()=>Theme);
parcelHelpers.export(exports, "U", ()=>DateProfileGenerator);
parcelHelpers.export(exports, "V", ()=>ViewContextType);
parcelHelpers.export(exports, "W", ()=>createEventUi);
parcelHelpers.export(exports, "X", ()=>parseBusinessHours);
parcelHelpers.export(exports, "Y", ()=>setRef);
parcelHelpers.export(exports, "Z", ()=>Interaction);
parcelHelpers.export(exports, "_", ()=>getElSeg);
parcelHelpers.export(exports, "a", ()=>mapHash);
parcelHelpers.export(exports, "a$", ()=>getSlotClassNames);
parcelHelpers.export(exports, "a0", ()=>EventImpl);
parcelHelpers.export(exports, "a1", ()=>listenBySelector);
parcelHelpers.export(exports, "a2", ()=>listenToHoverBySelector);
parcelHelpers.export(exports, "a3", ()=>PureComponent);
parcelHelpers.export(exports, "a4", ()=>buildViewContext);
parcelHelpers.export(exports, "a5", ()=>getUniqueDomId);
parcelHelpers.export(exports, "a6", ()=>parseInteractionSettings);
parcelHelpers.export(exports, "a7", ()=>interactionSettingsStore);
parcelHelpers.export(exports, "a8", ()=>getNow);
parcelHelpers.export(exports, "a9", ()=>CalendarImpl);
parcelHelpers.export(exports, "aA", ()=>diffDates);
parcelHelpers.export(exports, "aB", ()=>removeExact);
parcelHelpers.export(exports, "aC", ()=>memoizeArraylike);
parcelHelpers.export(exports, "aD", ()=>memoizeHashlike);
parcelHelpers.export(exports, "aE", ()=>intersectRects);
parcelHelpers.export(exports, "aF", ()=>pointInsideRect);
parcelHelpers.export(exports, "aG", ()=>constrainPoint);
parcelHelpers.export(exports, "aH", ()=>getRectCenter);
parcelHelpers.export(exports, "aI", ()=>diffPoints);
parcelHelpers.export(exports, "aJ", ()=>translateRect);
parcelHelpers.export(exports, "aK", ()=>compareObjs);
parcelHelpers.export(exports, "aL", ()=>collectFromHash);
parcelHelpers.export(exports, "aM", ()=>findElements);
parcelHelpers.export(exports, "aN", ()=>findDirectChildren);
parcelHelpers.export(exports, "aO", ()=>removeElement);
parcelHelpers.export(exports, "aP", ()=>applyStyle);
parcelHelpers.export(exports, "aQ", ()=>elementMatches);
parcelHelpers.export(exports, "aR", ()=>getEventTargetViaRoot);
parcelHelpers.export(exports, "aS", ()=>parseClassNames);
parcelHelpers.export(exports, "aT", ()=>getCanVGrowWithinCell);
parcelHelpers.export(exports, "aU", ()=>mergeEventStores);
parcelHelpers.export(exports, "aV", ()=>getRelevantEvents);
parcelHelpers.export(exports, "aW", ()=>eventTupleToStore);
parcelHelpers.export(exports, "aX", ()=>combineEventUis);
parcelHelpers.export(exports, "aY", ()=>Splitter);
parcelHelpers.export(exports, "aZ", ()=>getDayClassNames);
parcelHelpers.export(exports, "a_", ()=>getDateMeta);
parcelHelpers.export(exports, "aa", ()=>flushSync);
parcelHelpers.export(exports, "ab", ()=>CalendarRoot);
parcelHelpers.export(exports, "ac", ()=>RenderId);
parcelHelpers.export(exports, "ad", ()=>ensureElHasStyles);
parcelHelpers.export(exports, "ae", ()=>applyStyleProp);
parcelHelpers.export(exports, "af", ()=>sliceEventStore);
parcelHelpers.export(exports, "ag", ()=>JsonRequestError);
parcelHelpers.export(exports, "ah", ()=>createContext);
parcelHelpers.export(exports, "ai", ()=>refineProps);
parcelHelpers.export(exports, "aj", ()=>createEventInstance);
parcelHelpers.export(exports, "ak", ()=>parseEventDef);
parcelHelpers.export(exports, "al", ()=>refineEventDef);
parcelHelpers.export(exports, "am", ()=>padStart);
parcelHelpers.export(exports, "an", ()=>isInt);
parcelHelpers.export(exports, "ao", ()=>parseFieldSpecs);
parcelHelpers.export(exports, "ap", ()=>compareByFieldSpecs);
parcelHelpers.export(exports, "aq", ()=>flexibleCompare);
parcelHelpers.export(exports, "ar", ()=>preventSelection);
parcelHelpers.export(exports, "as", ()=>allowSelection);
parcelHelpers.export(exports, "at", ()=>preventContextMenu);
parcelHelpers.export(exports, "au", ()=>allowContextMenu);
parcelHelpers.export(exports, "av", ()=>compareNumbers);
parcelHelpers.export(exports, "aw", ()=>enableCursor);
parcelHelpers.export(exports, "ax", ()=>disableCursor);
parcelHelpers.export(exports, "ay", ()=>computeVisibleDayRange);
parcelHelpers.export(exports, "az", ()=>isMultiDayRange);
parcelHelpers.export(exports, "b", ()=>buildViewClassNames);
parcelHelpers.export(exports, "b$", ()=>SimpleScrollGrid);
parcelHelpers.export(exports, "b0", ()=>buildNavLinkAttrs);
parcelHelpers.export(exports, "b1", ()=>preventDefault);
parcelHelpers.export(exports, "b2", ()=>whenTransitionDone);
parcelHelpers.export(exports, "b3", ()=>computeInnerRect);
parcelHelpers.export(exports, "b4", ()=>computeEdges);
parcelHelpers.export(exports, "b5", ()=>getClippingParents);
parcelHelpers.export(exports, "b6", ()=>computeRect);
parcelHelpers.export(exports, "b7", ()=>rangesEqual);
parcelHelpers.export(exports, "b8", ()=>rangesIntersect);
parcelHelpers.export(exports, "b9", ()=>rangeContainsRange);
parcelHelpers.export(exports, "bA", ()=>SegHierarchy);
parcelHelpers.export(exports, "bB", ()=>buildEntryKey);
parcelHelpers.export(exports, "bC", ()=>getEntrySpanEnd);
parcelHelpers.export(exports, "bD", ()=>binarySearch);
parcelHelpers.export(exports, "bE", ()=>groupIntersectingEntries);
parcelHelpers.export(exports, "bF", ()=>intersectSpans);
parcelHelpers.export(exports, "bG", ()=>interactionSettingsToStore);
parcelHelpers.export(exports, "bH", ()=>ElementDragging);
parcelHelpers.export(exports, "bI", ()=>config);
parcelHelpers.export(exports, "bJ", ()=>parseDragMeta);
parcelHelpers.export(exports, "bK", ()=>DayHeader);
parcelHelpers.export(exports, "bL", ()=>computeFallbackHeaderFormat);
parcelHelpers.export(exports, "bM", ()=>TableDateCell);
parcelHelpers.export(exports, "bN", ()=>TableDowCell);
parcelHelpers.export(exports, "bO", ()=>DaySeriesModel);
parcelHelpers.export(exports, "bP", ()=>hasBgRendering);
parcelHelpers.export(exports, "bQ", ()=>buildSegTimeText);
parcelHelpers.export(exports, "bR", ()=>sortEventSegs);
parcelHelpers.export(exports, "bS", ()=>getSegMeta);
parcelHelpers.export(exports, "bT", ()=>buildEventRangeKey);
parcelHelpers.export(exports, "bU", ()=>getSegAnchorAttrs);
parcelHelpers.export(exports, "bV", ()=>DayTableModel);
parcelHelpers.export(exports, "bW", ()=>Slicer);
parcelHelpers.export(exports, "bX", ()=>applyMutationToEventStore);
parcelHelpers.export(exports, "bY", ()=>isPropsValid);
parcelHelpers.export(exports, "bZ", ()=>isInteractionValid);
parcelHelpers.export(exports, "b_", ()=>isDateSelectionValid);
parcelHelpers.export(exports, "ba", ()=>PositionCache);
parcelHelpers.export(exports, "bb", ()=>ScrollController);
parcelHelpers.export(exports, "bc", ()=>ElementScrollController);
parcelHelpers.export(exports, "bd", ()=>WindowScrollController);
parcelHelpers.export(exports, "be", ()=>DateComponent);
parcelHelpers.export(exports, "bf", ()=>isDateSpansEqual);
parcelHelpers.export(exports, "bg", ()=>addMs);
parcelHelpers.export(exports, "bh", ()=>addWeeks);
parcelHelpers.export(exports, "bi", ()=>diffWeeks);
parcelHelpers.export(exports, "bj", ()=>diffWholeWeeks);
parcelHelpers.export(exports, "bk", ()=>diffDayAndTime);
parcelHelpers.export(exports, "bl", ()=>diffDays);
parcelHelpers.export(exports, "bm", ()=>isValidDate);
parcelHelpers.export(exports, "bn", ()=>asCleanDays);
parcelHelpers.export(exports, "bo", ()=>multiplyDuration);
parcelHelpers.export(exports, "bp", ()=>addDurations);
parcelHelpers.export(exports, "bq", ()=>asRoughMinutes);
parcelHelpers.export(exports, "br", ()=>asRoughSeconds);
parcelHelpers.export(exports, "bs", ()=>asRoughMs);
parcelHelpers.export(exports, "bt", ()=>wholeDivideDurations);
parcelHelpers.export(exports, "bu", ()=>formatIsoTimeString);
parcelHelpers.export(exports, "bv", ()=>formatDayString);
parcelHelpers.export(exports, "bw", ()=>buildIsoString);
parcelHelpers.export(exports, "bx", ()=>formatIsoMonthStr);
parcelHelpers.export(exports, "by", ()=>NamedTimeZoneImpl);
parcelHelpers.export(exports, "bz", ()=>parse);
parcelHelpers.export(exports, "c", ()=>greatestDurationDenominator);
parcelHelpers.export(exports, "c0", ()=>hasShrinkWidth);
parcelHelpers.export(exports, "c1", ()=>renderMicroColGroup);
parcelHelpers.export(exports, "c2", ()=>getScrollGridClassNames);
parcelHelpers.export(exports, "c3", ()=>getSectionClassNames);
parcelHelpers.export(exports, "c4", ()=>getSectionHasLiquidHeight);
parcelHelpers.export(exports, "c5", ()=>getAllowYScrolling);
parcelHelpers.export(exports, "c6", ()=>renderChunkContent);
parcelHelpers.export(exports, "c7", ()=>computeShrinkWidth);
parcelHelpers.export(exports, "c8", ()=>sanitizeShrinkWidth);
parcelHelpers.export(exports, "c9", ()=>isColPropsEqual);
parcelHelpers.export(exports, "ca", ()=>renderScrollShim);
parcelHelpers.export(exports, "cb", ()=>getStickyFooterScrollbar);
parcelHelpers.export(exports, "cc", ()=>getStickyHeaderDates);
parcelHelpers.export(exports, "cd", ()=>Scroller);
parcelHelpers.export(exports, "ce", ()=>getScrollbarWidths);
parcelHelpers.export(exports, "cf", ()=>RefMap);
parcelHelpers.export(exports, "cg", ()=>getIsRtlScrollbarOnLeft);
parcelHelpers.export(exports, "ch", ()=>NowTimer);
parcelHelpers.export(exports, "ci", ()=>ScrollResponder);
parcelHelpers.export(exports, "cj", ()=>StandardEvent);
parcelHelpers.export(exports, "ck", ()=>NowIndicatorContainer);
parcelHelpers.export(exports, "cl", ()=>DayCellContainer);
parcelHelpers.export(exports, "cm", ()=>hasCustomDayCellContent);
parcelHelpers.export(exports, "cn", ()=>EventContainer);
parcelHelpers.export(exports, "co", ()=>renderFill);
parcelHelpers.export(exports, "cp", ()=>BgEvent);
parcelHelpers.export(exports, "cq", ()=>WeekNumberContainer);
parcelHelpers.export(exports, "cr", ()=>MoreLinkContainer);
parcelHelpers.export(exports, "cs", ()=>computeEarliestSegStart);
parcelHelpers.export(exports, "ct", ()=>ViewContainer);
parcelHelpers.export(exports, "cu", ()=>triggerDateSelect);
parcelHelpers.export(exports, "cv", ()=>getDefaultEventEnd);
parcelHelpers.export(exports, "cw", ()=>injectStyles);
parcelHelpers.export(exports, "cx", ()=>buildElAttrs);
parcelHelpers.export(exports, "cy", ()=>CustomRenderingStore);
...
class NativeFormatter {
    constructor(formatSettings){
        ...
        for(let name in formatSettings)if (name in EXTENDED_SETTINGS_AND_SEVERITIES) {
            ...
            if (name in STANDARD_DATE_PROP_SEVERITIES) severity = Math.max(STANDARD_DATE_PROP_SEVERITIES[name], severity);
        }
...
},{"preact":"26zcy","preact/compat":"aF0cT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"26zcy":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"aF0cT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"preact":"26zcy","preact/hooks":"eZN76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eZN76":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"preact":"26zcy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6nYtW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@fullcalendar/core/index.js":"dQNZA","./internal.js":"g1ZDy","@fullcalendar/core/internal.js":"4yP9O","@fullcalendar/core/preact.js":"aOC7L","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g1ZDy":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@fullcalendar/core/internal.js":"4yP9O","@fullcalendar/core/preact.js":"aOC7L","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4yP9O":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "BgEvent", ()=>(0, _internalCommonJs.cp));
parcelHelpers.export(exports, "CalendarImpl", ()=>(0, _internalCommonJs.a9));
parcelHelpers.export(exports, "CalendarRoot", ()=>(0, _internalCommonJs.ab));
parcelHelpers.export(exports, "ContentContainer", ()=>(0, _internalCommonJs.C));
parcelHelpers.export(exports, "CustomRenderingStore", ()=>(0, _internalCommonJs.cy));
parcelHelpers.export(exports, "DateComponent", ()=>(0, _internalCommonJs.be));
parcelHelpers.export(exports, "DateEnv", ()=>(0, _internalCommonJs.S));
parcelHelpers.export(exports, "DateProfileGenerator", ()=>(0, _internalCommonJs.U));
parcelHelpers.export(exports, "DayCellContainer", ()=>(0, _internalCommonJs.cl));
parcelHelpers.export(exports, "DayHeader", ()=>(0, _internalCommonJs.bK));
parcelHelpers.export(exports, "DaySeriesModel", ()=>(0, _internalCommonJs.bO));
parcelHelpers.export(exports, "DayTableModel", ()=>(0, _internalCommonJs.bV));
parcelHelpers.export(exports, "DelayedRunner", ()=>(0, _internalCommonJs.D));
parcelHelpers.export(exports, "ElementDragging", ()=>(0, _internalCommonJs.bH));
parcelHelpers.export(exports, "ElementScrollController", ()=>(0, _internalCommonJs.bc));
parcelHelpers.export(exports, "Emitter", ()=>(0, _internalCommonJs.F));
parcelHelpers.export(exports, "EventContainer", ()=>(0, _internalCommonJs.cn));
parcelHelpers.export(exports, "EventImpl", ()=>(0, _internalCommonJs.a0));
parcelHelpers.export(exports, "Interaction", ()=>(0, _internalCommonJs.Z));
parcelHelpers.export(exports, "MoreLinkContainer", ()=>(0, _internalCommonJs.cr));
parcelHelpers.export(exports, "NamedTimeZoneImpl", ()=>(0, _internalCommonJs.by));
parcelHelpers.export(exports, "NowIndicatorContainer", ()=>(0, _internalCommonJs.ck));
parcelHelpers.export(exports, "NowTimer", ()=>(0, _internalCommonJs.ch));
parcelHelpers.export(exports, "PositionCache", ()=>(0, _internalCommonJs.ba));
parcelHelpers.export(exports, "RefMap", ()=>(0, _internalCommonJs.cf));
parcelHelpers.export(exports, "ScrollController", ()=>(0, _internalCommonJs.bb));
parcelHelpers.export(exports, "ScrollResponder", ()=>(0, _internalCommonJs.ci));
parcelHelpers.export(exports, "Scroller", ()=>(0, _internalCommonJs.cd));
parcelHelpers.export(exports, "SegHierarchy", ()=>(0, _internalCommonJs.bA));
parcelHelpers.export(exports, "SimpleScrollGrid", ()=>(0, _internalCommonJs.b$));
parcelHelpers.export(exports, "Slicer", ()=>(0, _internalCommonJs.bW));
parcelHelpers.export(exports, "Splitter", ()=>(0, _internalCommonJs.aY));
parcelHelpers.export(exports, "StandardEvent", ()=>(0, _internalCommonJs.cj));
parcelHelpers.export(exports, "TableDateCell", ()=>(0, _internalCommonJs.bM));
parcelHelpers.export(exports, "TableDowCell", ()=>(0, _internalCommonJs.bN));
parcelHelpers.export(exports, "Theme", ()=>(0, _internalCommonJs.T));
parcelHelpers.export(exports, "ViewContainer", ()=>(0, _internalCommonJs.ct));
parcelHelpers.export(exports, "ViewContextType", ()=>(0, _internalCommonJs.V));
parcelHelpers.export(exports, "WeekNumberContainer", ()=>(0, _internalCommonJs.cq));
parcelHelpers.export(exports, "WindowScrollController", ()=>(0, _internalCommonJs.bd));
parcelHelpers.export(exports, "addDays", ()=>(0, _internalCommonJs.t));
parcelHelpers.export(exports, "addDurations", ()=>(0, _internalCommonJs.bp));
parcelHelpers.export(exports, "addMs", ()=>(0, _internalCommonJs.bg));
parcelHelpers.export(exports, "addWeeks", ()=>(0, _internalCommonJs.bh));
parcelHelpers.export(exports, "allowContextMenu", ()=>(0, _internalCommonJs.au));
parcelHelpers.export(exports, "allowSelection", ()=>(0, _internalCommonJs.as));
parcelHelpers.export(exports, "applyMutationToEventStore", ()=>(0, _internalCommonJs.bX));
parcelHelpers.export(exports, "applyStyle", ()=>(0, _internalCommonJs.aP));
parcelHelpers.export(exports, "asCleanDays", ()=>(0, _internalCommonJs.bn));
parcelHelpers.export(exports, "asRoughMinutes", ()=>(0, _internalCommonJs.bq));
parcelHelpers.export(exports, "asRoughMs", ()=>(0, _internalCommonJs.bs));
parcelHelpers.export(exports, "asRoughSeconds", ()=>(0, _internalCommonJs.br));
parcelHelpers.export(exports, "binarySearch", ()=>(0, _internalCommonJs.bD));
parcelHelpers.export(exports, "buildElAttrs", ()=>(0, _internalCommonJs.cx));
parcelHelpers.export(exports, "buildEntryKey", ()=>(0, _internalCommonJs.bB));
parcelHelpers.export(exports, "buildEventApis", ()=>(0, _internalCommonJs.w));
parcelHelpers.export(exports, "buildEventRangeKey", ()=>(0, _internalCommonJs.bT));
parcelHelpers.export(exports, "buildIsoString", ()=>(0, _internalCommonJs.bw));
parcelHelpers.export(exports, "buildNavLinkAttrs", ()=>(0, _internalCommonJs.b0));
parcelHelpers.export(exports, "buildSegTimeText", ()=>(0, _internalCommonJs.bQ));
parcelHelpers.export(exports, "collectFromHash", ()=>(0, _internalCommonJs.aL));
parcelHelpers.export(exports, "combineEventUis", ()=>(0, _internalCommonJs.aX));
parcelHelpers.export(exports, "compareByFieldSpecs", ()=>(0, _internalCommonJs.ap));
parcelHelpers.export(exports, "compareNumbers", ()=>(0, _internalCommonJs.av));
parcelHelpers.export(exports, "compareObjs", ()=>(0, _internalCommonJs.aK));
parcelHelpers.export(exports, "computeEarliestSegStart", ()=>(0, _internalCommonJs.cs));
parcelHelpers.export(exports, "computeEdges", ()=>(0, _internalCommonJs.b4));
parcelHelpers.export(exports, "computeFallbackHeaderFormat", ()=>(0, _internalCommonJs.bL));
parcelHelpers.export(exports, "computeInnerRect", ()=>(0, _internalCommonJs.b3));
parcelHelpers.export(exports, "computeRect", ()=>(0, _internalCommonJs.b6));
parcelHelpers.export(exports, "computeShrinkWidth", ()=>(0, _internalCommonJs.c7));
parcelHelpers.export(exports, "computeVisibleDayRange", ()=>(0, _internalCommonJs.ay));
parcelHelpers.export(exports, "config", ()=>(0, _internalCommonJs.bI));
parcelHelpers.export(exports, "constrainPoint", ()=>(0, _internalCommonJs.aG));
parcelHelpers.export(exports, "createDuration", ()=>(0, _internalCommonJs.d));
parcelHelpers.export(exports, "createEmptyEventStore", ()=>(0, _internalCommonJs.I));
parcelHelpers.export(exports, "createEventInstance", ()=>(0, _internalCommonJs.aj));
parcelHelpers.export(exports, "createEventUi", ()=>(0, _internalCommonJs.W));
parcelHelpers.export(exports, "createFormatter", ()=>(0, _internalCommonJs.x));
parcelHelpers.export(exports, "diffDates", ()=>(0, _internalCommonJs.aA));
parcelHelpers.export(exports, "diffDayAndTime", ()=>(0, _internalCommonJs.bk));
parcelHelpers.export(exports, "diffDays", ()=>(0, _internalCommonJs.bl));
parcelHelpers.export(exports, "diffPoints", ()=>(0, _internalCommonJs.aI));
parcelHelpers.export(exports, "diffWeeks", ()=>(0, _internalCommonJs.bi));
parcelHelpers.export(exports, "diffWholeDays", ()=>(0, _internalCommonJs.y));
parcelHelpers.export(exports, "diffWholeWeeks", ()=>(0, _internalCommonJs.bj));
parcelHelpers.export(exports, "disableCursor", ()=>(0, _internalCommonJs.ax));
parcelHelpers.export(exports, "elementClosest", ()=>(0, _internalCommonJs.$));
parcelHelpers.export(exports, "elementMatches", ()=>(0, _internalCommonJs.aQ));
parcelHelpers.export(exports, "enableCursor", ()=>(0, _internalCommonJs.aw));
parcelHelpers.export(exports, "eventTupleToStore", ()=>(0, _internalCommonJs.aW));
parcelHelpers.export(exports, "filterHash", ()=>(0, _internalCommonJs.h));
parcelHelpers.export(exports, "findDirectChildren", ()=>(0, _internalCommonJs.aN));
parcelHelpers.export(exports, "findElements", ()=>(0, _internalCommonJs.aM));
parcelHelpers.export(exports, "flexibleCompare", ()=>(0, _internalCommonJs.aq));
parcelHelpers.export(exports, "formatDayString", ()=>(0, _internalCommonJs.bv));
parcelHelpers.export(exports, "formatIsoMonthStr", ()=>(0, _internalCommonJs.bx));
parcelHelpers.export(exports, "formatIsoTimeString", ()=>(0, _internalCommonJs.bu));
parcelHelpers.export(exports, "getAllowYScrolling", ()=>(0, _internalCommonJs.c5));
parcelHelpers.export(exports, "getCanVGrowWithinCell", ()=>(0, _internalCommonJs.aT));
parcelHelpers.export(exports, "getClippingParents", ()=>(0, _internalCommonJs.b5));
parcelHelpers.export(exports, "getDateMeta", ()=>(0, _internalCommonJs.a_));
parcelHelpers.export(exports, "getDayClassNames", ()=>(0, _internalCommonJs.aZ));
parcelHelpers.export(exports, "getDefaultEventEnd", ()=>(0, _internalCommonJs.cv));
parcelHelpers.export(exports, "getElSeg", ()=>(0, _internalCommonJs._));
parcelHelpers.export(exports, "getEntrySpanEnd", ()=>(0, _internalCommonJs.bC));
parcelHelpers.export(exports, "getEventTargetViaRoot", ()=>(0, _internalCommonJs.aR));
parcelHelpers.export(exports, "getIsRtlScrollbarOnLeft", ()=>(0, _internalCommonJs.cg));
parcelHelpers.export(exports, "getRectCenter", ()=>(0, _internalCommonJs.aH));
parcelHelpers.export(exports, "getRelevantEvents", ()=>(0, _internalCommonJs.aV));
parcelHelpers.export(exports, "getScrollGridClassNames", ()=>(0, _internalCommonJs.c2));
parcelHelpers.export(exports, "getScrollbarWidths", ()=>(0, _internalCommonJs.ce));
parcelHelpers.export(exports, "getSectionClassNames", ()=>(0, _internalCommonJs.c3));
parcelHelpers.export(exports, "getSectionHasLiquidHeight", ()=>(0, _internalCommonJs.c4));
parcelHelpers.export(exports, "getSegAnchorAttrs", ()=>(0, _internalCommonJs.bU));
parcelHelpers.export(exports, "getSegMeta", ()=>(0, _internalCommonJs.bS));
parcelHelpers.export(exports, "getSlotClassNames", ()=>(0, _internalCommonJs.a$));
parcelHelpers.export(exports, "getStickyFooterScrollbar", ()=>(0, _internalCommonJs.cb));
parcelHelpers.export(exports, "getStickyHeaderDates", ()=>(0, _internalCommonJs.cc));
parcelHelpers.export(exports, "getUniqueDomId", ()=>(0, _internalCommonJs.a5));
parcelHelpers.export(exports, "greatestDurationDenominator", ()=>(0, _internalCommonJs.c));
parcelHelpers.export(exports, "groupIntersectingEntries", ()=>(0, _internalCommonJs.bE));
parcelHelpers.export(exports, "guid", ()=>(0, _internalCommonJs.g));
parcelHelpers.export(exports, "hasBgRendering", ()=>(0, _internalCommonJs.bP));
parcelHelpers.export(exports, "hasCustomDayCellContent", ()=>(0, _internalCommonJs.cm));
parcelHelpers.export(exports, "hasShrinkWidth", ()=>(0, _internalCommonJs.c0));
parcelHelpers.export(exports, "identity", ()=>(0, _internalCommonJs.n));
parcelHelpers.export(exports, "injectStyles", ()=>(0, _internalCommonJs.cw));
parcelHelpers.export(exports, "interactionSettingsStore", ()=>(0, _internalCommonJs.a7));
parcelHelpers.export(exports, "interactionSettingsToStore", ()=>(0, _internalCommonJs.bG));
parcelHelpers.export(exports, "intersectRanges", ()=>(0, _internalCommonJs.o));
parcelHelpers.export(exports, "intersectRects", ()=>(0, _internalCommonJs.aE));
parcelHelpers.export(exports, "intersectSpans", ()=>(0, _internalCommonJs.bF));
parcelHelpers.export(exports, "isArraysEqual", ()=>(0, _internalCommonJs.i));
parcelHelpers.export(exports, "isColPropsEqual", ()=>(0, _internalCommonJs.c9));
parcelHelpers.export(exports, "isDateSelectionValid", ()=>(0, _internalCommonJs.b_));
parcelHelpers.export(exports, "isDateSpansEqual", ()=>(0, _internalCommonJs.bf));
parcelHelpers.export(exports, "isInt", ()=>(0, _internalCommonJs.an));
parcelHelpers.export(exports, "isInteractionValid", ()=>(0, _internalCommonJs.bZ));
parcelHelpers.export(exports, "isMultiDayRange", ()=>(0, _internalCommonJs.az));
parcelHelpers.export(exports, "isPropsEqual", ()=>(0, _internalCommonJs.E));
parcelHelpers.export(exports, "isPropsValid", ()=>(0, _internalCommonJs.bY));
parcelHelpers.export(exports, "isValidDate", ()=>(0, _internalCommonJs.bm));
parcelHelpers.export(exports, "mapHash", ()=>(0, _internalCommonJs.a));
parcelHelpers.export(exports, "memoize", ()=>(0, _internalCommonJs.z));
parcelHelpers.export(exports, "memoizeArraylike", ()=>(0, _internalCommonJs.aC));
parcelHelpers.export(exports, "memoizeHashlike", ()=>(0, _internalCommonJs.aD));
parcelHelpers.export(exports, "memoizeObjArg", ()=>(0, _internalCommonJs.A));
parcelHelpers.export(exports, "mergeEventStores", ()=>(0, _internalCommonJs.aU));
parcelHelpers.export(exports, "multiplyDuration", ()=>(0, _internalCommonJs.bo));
parcelHelpers.export(exports, "padStart", ()=>(0, _internalCommonJs.am));
parcelHelpers.export(exports, "parseBusinessHours", ()=>(0, _internalCommonJs.X));
parcelHelpers.export(exports, "parseClassNames", ()=>(0, _internalCommonJs.aS));
parcelHelpers.export(exports, "parseDragMeta", ()=>(0, _internalCommonJs.bJ));
parcelHelpers.export(exports, "parseEventDef", ()=>(0, _internalCommonJs.ak));
parcelHelpers.export(exports, "parseFieldSpecs", ()=>(0, _internalCommonJs.ao));
parcelHelpers.export(exports, "parseMarker", ()=>(0, _internalCommonJs.bz));
parcelHelpers.export(exports, "pointInsideRect", ()=>(0, _internalCommonJs.aF));
parcelHelpers.export(exports, "preventContextMenu", ()=>(0, _internalCommonJs.at));
parcelHelpers.export(exports, "preventDefault", ()=>(0, _internalCommonJs.b1));
parcelHelpers.export(exports, "preventSelection", ()=>(0, _internalCommonJs.ar));
parcelHelpers.export(exports, "rangeContainsMarker", ()=>(0, _internalCommonJs.H));
parcelHelpers.export(exports, "rangeContainsRange", ()=>(0, _internalCommonJs.b9));
parcelHelpers.export(exports, "rangesEqual", ()=>(0, _internalCommonJs.b7));
parcelHelpers.export(exports, "rangesIntersect", ()=>(0, _internalCommonJs.b8));
parcelHelpers.export(exports, "refineEventDef", ()=>(0, _internalCommonJs.al));
parcelHelpers.export(exports, "refineProps", ()=>(0, _internalCommonJs.ai));
parcelHelpers.export(exports, "removeElement", ()=>(0, _internalCommonJs.aO));
parcelHelpers.export(exports, "removeExact", ()=>(0, _internalCommonJs.aB));
parcelHelpers.export(exports, "renderChunkContent", ()=>(0, _internalCommonJs.c6));
parcelHelpers.export(exports, "renderFill", ()=>(0, _internalCommonJs.co));
parcelHelpers.export(exports, "renderMicroColGroup", ()=>(0, _internalCommonJs.c1));
parcelHelpers.export(exports, "renderScrollShim", ()=>(0, _internalCommonJs.ca));
parcelHelpers.export(exports, "requestJson", ()=>(0, _internalCommonJs.r));
parcelHelpers.export(exports, "sanitizeShrinkWidth", ()=>(0, _internalCommonJs.c8));
parcelHelpers.export(exports, "setRef", ()=>(0, _internalCommonJs.Y));
parcelHelpers.export(exports, "sliceEventStore", ()=>(0, _internalCommonJs.af));
parcelHelpers.export(exports, "sortEventSegs", ()=>(0, _internalCommonJs.bR));
parcelHelpers.export(exports, "startOfDay", ()=>(0, _internalCommonJs.q));
parcelHelpers.export(exports, "translateRect", ()=>(0, _internalCommonJs.aJ));
parcelHelpers.export(exports, "triggerDateSelect", ()=>(0, _internalCommonJs.cu));
parcelHelpers.export(exports, "unpromisify", ()=>(0, _internalCommonJs.u));
parcelHelpers.export(exports, "whenTransitionDone", ()=>(0, _internalCommonJs.b2));
parcelHelpers.export(exports, "wholeDivideDurations", ()=>(0, _internalCommonJs.bt));
var _internalCommonJs = require("./internal-common.js");
var _preact = require("preact");
var _compat = require("preact/compat");

},{"./internal-common.js":"BjSPd","preact":"26zcy","preact/compat":"aF0cT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aOC7L":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createPortal", ()=>(0, _compat.createPortal));
parcelHelpers.export(exports, "createContext", ()=>(0, _internalCommonJs.ah));
parcelHelpers.export(exports, "flushSync", ()=>(0, _internalCommonJs.aa));
var _preact = require("preact");
parcelHelpers.exportAll(_preact, exports);
var _compat = require("preact/compat");
var _internalCommonJs = require("./internal-common.js");

},{"preact":"26zcy","preact/compat":"aF0cT","./internal-common.js":"BjSPd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"84iWu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@fullcalendar/core/index.js":"dQNZA","@fullcalendar/core/internal.js":"4yP9O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4T3hU","7r0UO"], "7r0UO", "parcelRequire94c2")

//# sourceMappingURL=script.js.81dbb8cc87f2.map
